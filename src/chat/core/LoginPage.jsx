...
const LoginPage = () => {
    ...
    return(
        <section className=" lg:w-1/3 lg:absolute lg:right-0  w-screen h-screen  flex flex-col items-start justify-start gap-2 px-2" style={{background:'rgb(255,255,255,0.01)'}}>
            <form onKeyDown={e => null} className=" flex flex-col justify-evenly items-start h-max w-full text-neutral-300 px-4 py-8 ">
                 <p className="text-2xl text-neutral-200 w-full font-semibold ">Welcome to <span style={{color:'transparent',background:Theme.BlueGradient90,backgroundClip:'text'}}>ChatBotify</span></p>
