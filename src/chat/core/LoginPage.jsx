...
const LoginPage = () => {
    ...
    return(
        <section className="lg:h-max lg:w-1/3  w-screen h-screen rounded-2xl flex flex-col gap-2 px-2" style={{background:'rgb(255,255,255,0.01)'}}>
            ...
            <form onKeyDown={e => null} className=" flex flex-col justify-evenly items-start h-1/2 w-full text-neutral-300 px-4 gap-8">
                <div className="w-full flex flex-row items-center gap-4">
                    <span className=" flex-grow py-1 px-4 rounded-2xl" style={{background:Theme.DarkPrimaryTrans}}>
                        ...
                        <input ref={username} type="text" className="w-full bg-transparent   outline-0" />
                    </span>
                ...
                <div className="w-full flex flex-row items-center gap-4">
                    <span className=" w-full py-1 px-4 rounded-2xl" style={{background:Theme.DarkPrimaryTrans}}>
                        ...
                        <input autoComplete="off" ref={password} type="password"  className="w-full bg-transparent  outline-0 "  />
                    </span>
                ...
                {/* onClick={() => Validate({username:text_box.current,password:pass_box.current})} */}
