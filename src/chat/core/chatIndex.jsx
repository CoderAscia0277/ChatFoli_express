        ...
        <section className="lg:w-2/6 md:w-2/5 w-full lg:3/4 md:3/4 h-full absolute xs:left-0  lg:top-0 md:top-0 bottom-0 bg-neutral-900 lg:rounded-xl md:rounded-xl  mt-0 flex flex-col">
            <article className="w-full min-h-16 flex flex-row items-center px-2">
                ...
                <div className="flex-grow h-full flex flex-row justify-center items-center">
                    <span className="font-sans font-bold border  min-w-20 min-h-10 text-white rounded-2xl flex flex-row items-center px-4">
                        Sample Title
                    </span>
                </div>
            ...
            <article className="w-full min-h-20  flex flex-row items-center justify-around px-2">
                ...
                <textarea placeholder="Say something . . ." onFocus={() => setTogglingPanel(toggling_panel ? false : '')} onChange={HandleChange}  className="text-start border bg-transparent outline-0 lg:w-3/5 md:w-3/5 sm:w-3/4 w-1/2 py-2 text-white rounded-2xl flex flex-row items-center px-4 " style={{resize:'none'}}></textarea>
