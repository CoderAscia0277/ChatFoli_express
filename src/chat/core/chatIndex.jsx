...
const ChatIndex = () => {
    ...
    return(
        <section className="lg:w-2/6 md:w-2/5 w-full lg:3/4 md:3/4 h-full absolute xs:left-0  lg:top-0 md:top-0 bottom-0 bg-neutral-900 lg:rounded-xl md:rounded-xl  mt-0 flex flex-col py-2 ">
            ...
            <article className={`w-full overflow-hidden transition-opacity min-h-20 flex flex-row items-center justify-around px-2 ${DialogueState ? '' : 'opacity-0 pointer-events-none'}  `}>
