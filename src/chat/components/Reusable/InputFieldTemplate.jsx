                        ...
                        <div id={label}   className={`flex flex-row  flex-grow  py-2 rounded-2xl items-center   `} >
                            <span className="flex flex-row flex-grow gap-4 items-center">
                                ...
                                <input
                                    ref={refVal} 
                                    autoComplete="off"  
                                    onChange={(e) => error_message ? resetComponent() : null} 
                                    placeholder={label}  
                                    type={input_type} 
                                    style={{
                                        color:Theme.TextColor,
                                        outlineColor:error_message ? Theme.error : Theme.default,
                                        outlineWidth:'1px',accentColor:Theme.color_50 , 
                                        background:Theme.color_50,
