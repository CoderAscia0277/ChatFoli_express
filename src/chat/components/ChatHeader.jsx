...
const ChatHeader = ({}) => {
    ...
    return(
    <article  className={` $overflow-y-hidden w-full h-max gap-2 bg-neutral-800  flex flex-row justify-start items-center px-2 py-2`}>
        ...
        <div className="flex-grow h-full flex flex-col items-start justify-start px-4">
            ...
            <span className="text-neutral-400 text-sm">It's time to study again...</span>
        </div>
