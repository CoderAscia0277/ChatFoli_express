...
const Monologue = ({value='none'}) => {
    ...
    return(
        <section className="content w-full  min-h-30 flex flex-row px-4 pb-4 " style={{border:'solid 1px white',borderLeft:0,borderRight:0,background:'rgba(255,255,255,0.03)'}}>
