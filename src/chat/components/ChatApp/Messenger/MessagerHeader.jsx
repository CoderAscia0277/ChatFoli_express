...
const ChatHeader = ({TAG=''}) => {
    ...
    return(
    <article  className={` cursor-default overflow-y-hidden h-max  absolute  top-0 flex flex-row justify-start items-center px-4 pt-4 pb-1`} style={{backdropFilter:'blur(2px)',width:'-webkit-fill-available',background:'linear-gradient(180deg, rgb(23 23 23),rgba(23,23,23,1),rgba(23,23,23,0.8) , rgba(23,23,23,0.5),rgba(23,23,23,0.3), rgba(23,23,23,0))'}}>
