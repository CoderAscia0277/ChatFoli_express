...
const ChatHeader = ({TAG=''}) => {
    ...
    const [{STATUS,ICON,NAME},set_contact_profile_info] = useState(MessengerStore.getState().INFO);
    ...
    return(
    <article  className={` cursor-default overflow-y-hidden w-full h-max  absolute  top-0 flex flex-row justify-start items-center px-8 pt-4 pb-1`} style={{backdropFilter:'blur(2px)',background:'linear-gradient(180deg, rgb(23 23 23),rgba(23,23,23,1),rgba(23,23,23,0.8) , rgba(23,23,23,0.5),rgba(23,23,23,0.3), rgba(23,23,23,0))'}}>
