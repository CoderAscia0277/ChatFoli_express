...
const ChatHeader = ({TAG='',NAME='',ICON,STATUS = null,REDIRECT = (state) => null}) => {
    ...
    return(
    <article  className={` cursor-default overflow-y-hidden w-full h-max  absolute  top-0 flex flex-row justify-start items-center px-8 py-4 `} style={{background:'linear-gradient(180deg, rgb(23 23 23),rgba(23,23,23,1),rgba(23,23,23,0.8) , rgba(23,23,23,0.3), rgba(23,23,23,0))'}}>
